...
# HubSpot API constants
HUBSPOT_CLIENT_ID = os.environ.get("HUBSPOT_CLIENT_ID", "your_client_id")  # Replace with your client ID if not using env var
HUBSPOT_CLIENT_SECRET = os.environ.get("HUBSPOT_CLIENT_SECRET", "your_client_secret")  # Replace with your client secret if not using env var
HUBSPOT_REDIRECT_URI = os.environ.get("HUBSPOT_REDIRECT_URI", "http://localhost:8000/integrations/hubspot/oauth2callback")
