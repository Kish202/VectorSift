...
#  ✅ Handle CORS preflight for POST request
# @app.options('/integrations/hubspot/credentials')
# async def options_hubspot_credentials():
...
origins = [
    ...
    "http://127.0.0.1:3000",
    "null"  # if you're opening HTML file directly in browser
]
...
async def authorize(user_id: str = Form(...), org_id: str = Form(...)):
    return {
        "status": "success",
        "message": f"Authorized user {user_id} for org {org_id}"
    }
